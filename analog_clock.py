...
class main(Tkinter.Tk):
    def __init__(self):
        ...
        self.x = 175  # Center Point x
        self.y = 175  # Center Point y
        self.lengthx = 100  # Stick Length
        self.lengthy = 125
    ...
    def creating_background_(self):
        self.image = Tkinter.PhotoImage(file='tarcza3.gif')
    ...
    def creating_sticks(self):
        ...
        for i in range(3):
            store = self.canvas.create_line(
                self.x, self.y, self.x + self.lengthx, self.y+self.lengthy, width=7, fill='purple')
    ...
    def update_class(self):
        ...
        for n, i in enumerate(now):
            ...
            cr = [x, y]
            cr.append(self.lengthx*math.cos(math.radians(i*6) -
                      math.radians(90))+self.x)
            cr.append(self.lengthy*math.sin(math.radians(i*6) -
                      math.radians(90))+self.y)
